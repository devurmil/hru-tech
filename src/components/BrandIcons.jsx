/**
 * Brand marks. lucide-react removed its brand icons, so these are inlined
 * from the official simple-icons paths.
 */
const base = {
  viewBox: '0 0 24 24',
  fill: 'currentColor',
...
export function XIcon({ size = 16, ...rest }) {
  return (
    <svg {...base} width={size} height={size} {...rest}>
      <path d="M18.9 1.2h3.68l-8.04 9.19L24 22.8h-7.4l-5.8-7.58-6.64 7.58H.47l8.6-9.83L0 1.2h7.59l5.24 6.93L18.9 1.2zm-1.3 19.4h2.04L6.48 3.29H4.3L17.6 20.6z" />
    </svg>
  )
}
